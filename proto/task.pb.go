...
var file_task_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x70, 0x61, 0x69, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e,
	0x74, 0x61, 0x73, 0x6b, 0x2e, 0x50, 0x61, 0x69, 0x72, 0x52, 0x05, 0x70, 0x61, 0x69, 0x72, 0x73,
...
var file_task_proto_goTypes = []interface{}{
	...
	(*Endpoint)(nil),  // 2: task.Endpoint
	(*Pair)(nil),      // 3: task.Pair
	(*Job)(nil),       // 4: job.Job
}
var file_task_proto_depIdxs = []int32{
	2, // 0: task.Task.endpoints:type_name -> task.Endpoint
	4, // 1: task.Task.job:type_name -> job.Job
	3, // 2: task.Endpoint.pairs:type_name -> task.Pair
