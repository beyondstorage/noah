...
// Source: github.com/aos-dev/go-storage/v2/types (interfaces: Copier,DirLister,DirSegmentsLister,IndexSegmenter,Mover,PrefixLister,PrefixSegmentsLister,Reacher,Servicer,Statistician,Storager)
...
// MockDirSegmentsLister is a mock of DirSegmentsLister interface
type MockDirSegmentsLister struct {
	ctrl     *gomock.Controller
	recorder *MockDirSegmentsListerMockRecorder
}

// MockDirSegmentsListerMockRecorder is the mock recorder for MockDirSegmentsLister
type MockDirSegmentsListerMockRecorder struct {
	mock *MockDirSegmentsLister
}

// NewMockDirSegmentsLister creates a new mock instance
func NewMockDirSegmentsLister(ctrl *gomock.Controller) *MockDirSegmentsLister {
	mock := &MockDirSegmentsLister{ctrl: ctrl}
	mock.recorder = &MockDirSegmentsListerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockDirSegmentsLister) EXPECT() *MockDirSegmentsListerMockRecorder {
	return m.recorder
}
...
func (mr *MockDirSegmentsListerMockRecorder) AbortSegment(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0}, arg1...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AbortSegment", reflect.TypeOf((*MockDirSegmentsLister)(nil).AbortSegment), varargs...)
}
...
func (mr *MockDirSegmentsListerMockRecorder) AbortSegmentWithContext(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AbortSegmentWithContext", reflect.TypeOf((*MockDirSegmentsLister)(nil).AbortSegmentWithContext), varargs...)
}
...
func (mr *MockDirSegmentsListerMockRecorder) CompleteSegment(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0}, arg1...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CompleteSegment", reflect.TypeOf((*MockDirSegmentsLister)(nil).CompleteSegment), varargs...)
}
...
func (mr *MockDirSegmentsListerMockRecorder) CompleteSegmentWithContext(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CompleteSegmentWithContext", reflect.TypeOf((*MockDirSegmentsLister)(nil).CompleteSegmentWithContext), varargs...)
}
...
func (m *MockDirSegmentsLister) ListDirSegments(arg0 string, arg1 ...types.Pair) (*types.SegmentIterator, error) {
	...
	ret := m.ctrl.Call(m, "ListDirSegments", varargs...)
	ret0, _ := ret[0].(*types.SegmentIterator)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListDirSegments indicates an expected call of ListDirSegments
func (mr *MockDirSegmentsListerMockRecorder) ListDirSegments(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0}, arg1...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListDirSegments", reflect.TypeOf((*MockDirSegmentsLister)(nil).ListDirSegments), varargs...)
}
...
func (m *MockDirSegmentsLister) ListDirSegmentsWithContext(arg0 context.Context, arg1 string, arg2 ...types.Pair) (*types.SegmentIterator, error) {
	...
	ret := m.ctrl.Call(m, "ListDirSegmentsWithContext", varargs...)
	ret0, _ := ret[0].(*types.SegmentIterator)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListDirSegmentsWithContext indicates an expected call of ListDirSegmentsWithContext
func (mr *MockDirSegmentsListerMockRecorder) ListDirSegmentsWithContext(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListDirSegmentsWithContext", reflect.TypeOf((*MockDirSegmentsLister)(nil).ListDirSegmentsWithContext), varargs...)
}
